    ...
    content: `
      <div class="card-body">
        ...
        <ul class="tight">
          ...
          <li><b><code>ADD</code></b>: עושה את מה ש-COPY עושה, <b>אבל בנוסף</b> אם תתנו לה קישור ל-URL היא תוריד אותו, ואם תתנו לה קובץ `.tar.gz` היא תחלץ אותו אוטומטית פנימה.</li>
        </ul>
