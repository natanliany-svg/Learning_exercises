  ...
  visualizerSteps: [
        ...
        },
        {
            ...
            <div class="memory-grid fade-slide-up">
                <div class="memory-cell locked"><div class="cell-label">Private Var<!-- removed extra div --><div class="cell-value">🔒 מוסתר<!-- removed extra div --></div>
...
<span class="t-key">import</span> multiply, { PI, add } <span class="t-key">from</span> <span class="t-str">"./math.js"</span>;</code></pre>
 ...
 destructuring: {
    visualizerSteps: [
        {
            html_visual: `
            <div class="anim-container"><div class="anim-node">{a: 1, b: 2}<!-- removed extra div --><div class="anim-packet move-right" style="background:#00d2ff; width:50px;">פירוק<!-- removed extra div --><div class="anim-node">const a = 1<!-- removed extra div --><!-- removed extra div -->
            `,
...
<span class="t-com">// head = 10, tail = [20, 30, 40]</span></code></pre>
  ...
  `
    </div></div></div></div> <!-- auto added divs -->
 },
 syntaxWarehouse: {
...
`
 ...
 , expressKids: {
    visualizerSteps: [
        {
            html_visual: `
            <div class="anim-container"><div class="anim-node">ילד רעב<!-- removed extra div --><div class="anim-packet move-right" style="background:#ff9800;">הזמנה לפסטה<!-- removed extra div --><div class="anim-node">טבח (Express)<!-- removed extra div --><!-- removed extra div -->
            `,
...
return new Promise((resolve, reject) => {
 ...
 expressValidationsClassroom: {
    visualizerSteps: [
        {
            html_visual: `
            <div class="anim-container"><div class="anim-packet move-right" style="background:#ff0055;">{age: -5}<!-- removed extra div --><div class="anim-node" style="border-color:#f7df1e;">שומר (Joi)<!-- removed extra div --><div class="anim-node" style="border-color:#ff0055;">400 Bad Request<!-- removed extra div --><!-- removed extra div -->
            `,
