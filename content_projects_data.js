...
const techEnglishDatabase = [
  { term: "Query", definition: "שאילתה. בקשה לשליפת נתונים או ביצוע פעולה במסד הנתונים." },
  { term: "Schema", definition: "סכמה. התכנון המבני של מסד הנתונים, הכולל את הטבלאות, העמודות והקשרים ביניהן." },
  { term: "Table", definition: "טבלה. אוסף של נתונים המאורגנים בשורות (רשומות) ועמודות (שדות) במסד נתונים רלציוני." },
  { term: "Join", definition: "צירוף. פעולה ב-SQL המחברת נתונים משתי טבלאות או יותר על בסיס עמודה משותפת." },
  { term: "Primary Key", definition: "מפתח ראשי. עמודה שמזהה באופן ייחודי כל שורה בטבלה. לא יכולה להכיל ערך כפול או ריק." },
  { term: "Foreign Key", definition: "מפתח זר. עמודה המקשרת שורה אחת בטבלה לשורה בטבלה אחרת, במטרה לאכוף שלמות נתונים." },
  { term: "Connection Pool", definition: "מאגר חיבורים. טכניקה לניהול ושימוש חוזר בחיבורים פתוחים למסד הנתונים כדי לשפר ביצועים." },
  { term: "Index", definition: "אינדקס. מבנה נתונים שמאיץ את מהירות שליפת הנתונים מהטבלה על חשבון פעולות הכתיבה." },
  { term: "Transaction", definition: "טרנזקציה. אוסף פעולות המבוצעות כיחידה אחת שלמה (הכל מצליח, או שהכל מבוטל יחד)." },
  { term: "Normalization", definition: "נרמול. תהליך של ארגון נתונים כדי לצמצם כפילויות ולשפר את שלמות הנתונים במסד." },
  { term: "Deployment", definition: "פריסה. תהליך העברת הקוד מסביבת הפיתוח לשרת הייצור כך שיהיה זמין למשתמשים קצה." },
  { term: "Load Balancer", definition: "נתב עומסים. רכיב מערכת המחלק את התעבורה הנכנסת בין מספר שרתים כדי למנוע קריסה." },
  { term: "CI/CD", definition: "שילוב ופריסה רציפים. מתודולוגיה לאוטומציה של בדיקות והעלאת קוד בצורה מהירה ובטוחה ללא מגע אדם." },
  { term: "Scalability", definition: "סקלאביליות. היכולת של המערכת להתמודד עם עומס עבודה הולך וגדל על ידי הוספת משאבים." },
  { term: "Microservices", definition: "מיקרו-שירותים. ארכיטקטורת תוכנה שבה המערכת מורכבת מהרבה שירותים קטנים ובלתי תלויים התקשרים ב-API." }
];
