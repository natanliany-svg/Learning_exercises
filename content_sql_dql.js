...
<div class="sql-section">
        <h3>עשיית סדר בכאוס: ORDER BY</h3>
...
<div class="sql-section">
        <h3>מבט על: פונקציות צבירה (Aggregate Functions)</h3>
...
<div class="sql-section">
        <h3>קיבוץ לקטגוריות: GROUP BY</h3>
